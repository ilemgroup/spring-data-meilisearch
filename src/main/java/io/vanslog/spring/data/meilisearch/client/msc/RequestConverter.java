...
public class RequestConverter {
    ...
    @Nullable
    private FederationOptions convertFederationOptions(@Nullable io.vanslog.spring.data.meilisearch.core.query.FederationOptions federationOptions) {
    ...
    @Nullable
    private com.meilisearch.sdk.model.MatchingStrategy convertMatchingStrategy(@Nullable MatchingStrategy matchingStrategy) {
    ...
    private String[] convertSortToSortOptions(@Nullable Sort sort) {
        ...
        return sort.stream().map(order -> order.getProperty() + ":" + (order.isAscending() ? "asc" : "desc")).toArray(String[]::new);
    }
}
