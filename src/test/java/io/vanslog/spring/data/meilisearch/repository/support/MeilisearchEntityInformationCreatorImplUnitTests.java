...
class MeilisearchEntityInformationCreatorImplUnitTests {
	...
	@BeforeEach
	void setUp() {
		SimpleMeilisearchMappingContext context = new SimpleMeilisearchMappingContext();
		entityInformationCreator = new MeilisearchEntityInformationCreatorImpl(context);
	}

	@Test
	void shouldCreateEntityInformation() {
		assertThat(entityInformationCreator.getEntityInformation(Movie.class)).isNotNull();
	}
